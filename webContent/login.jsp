...
<body>
	...
	<div class="login">
		...
		<form class="form_Login" action="login" method="post">
			<label for="user_Name">Usename</label><br> <input type="text"
				class="input_login" id="input_Name" name="username"
				placeholder="Enter Username"><br> <label for="pass">Password</label><br>
				
			<input type="password" class="input_login" name="password"
				id="input_Pass" placeholder="Enter Password"><br>
			<h7 style="color: red"><%=err%></h7>
			
			<input type="submit" class="input_login" id="input_Submit"
				value="Login"><br> <label for="user_Remembere">Remembere
				me</label> <input type="checkbox" id="user_Remembere"><br>
		</form>
		<div>
